...
### Added
- Comprehensive GitHub workflow setup inspired by Laravel
- Matrix testing for PHP 8.2, 8.3, 8.4
- Scheduled daily test runs
- Automated issue labeling and management
- Automated PR handling with size labels
